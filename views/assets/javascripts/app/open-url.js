$(function () {
    ...
    function collectSelectID() {
        ...
        let $checked = $(".qor-js-table tbody").find(".mdl-checkbox__input:checked"),IDs = [];
    ...
    $(document).on("click.qor.openUrl", "[data-url]", function (e) {
        ...
        if (isActionButton) {
            ...
            if (actionData) {
                console.log('action',actionData,openData)
        ...
        try {
            // /admin/theme_config/0/select_theme - TODO:  INSERIRE ID 0 prima della action
            if (IsSingleton && IsSingleton === true) {
                console.log("OPEN",openData,BottomSheets)
